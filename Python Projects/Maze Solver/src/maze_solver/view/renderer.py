...
from maze_solver.view.primitives import Point, Polyline, Polygon, Rect, Text, tag

# Using enums to defining a mapping of a subset of role members to emoji icons
ROLE_EMOJI = {
...
class SVG:
    ...
    # Returns a minimal HTML5 website with the rendered SVG
    @property
...
# Will incorporate the square size and line width as input parameters
@dataclass(frozen=True)
class SVGRenderer:
    square_size: int = 100
    line_width: int = 6
    ...
    # Calculating SVG based on size of maze and the squares
    ...
    # Drawing Squares -- based on helpeer functions
    ...
    # Transforming squares of the solution to get their corresponding pixel coordinates 
...
# Drawing an arrow for the users location in the maze        
